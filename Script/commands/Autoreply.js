...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস SUNNY LEON রে হাঙ্গা করো😶👻😘",
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু SUNNY LEON বস বেশি করে 😏💖",
    ...
    "good night": "Sweet Dream babu… তবে আগে SUNNY LEON বস কে GN বলে নিও 😏💤",
    ...
    "admin": "He is SUNNY LEON তাকে সবাই Admin MAGI হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস SUNNY LEON রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস SUNNY LEON এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss SUNNY LEON এর ইনবক্সে গুতা দিন 😘",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌SUNNY LEON 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
